"""Exception hierarchy for CAScadq."""


class CascadqError(Exception):
    """Base exception for all CAScadq errors."""


class ConflictError(CascadqError):
    """CAS version mismatch — another writer has intervened."""
...
class QueueEmptyError(CascadqError):
